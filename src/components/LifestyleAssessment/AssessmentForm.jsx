...
const AssessmentForm = ({
    ...
    const [formData, setFormData] = useState({
        sleepTime: initialData?.sleepTime?.substring(0, 5) || '22:00',
        wakeUpTime: initialData?.wakeUpTime?.substring(0, 5) || '06:00',
        mealsPerDay: initialData?.mealsPerDay || 3,
        exerciseFrequency: initialData?.exerciseFrequency || 'MODERATE',
        studyWorkHours: initialData?.studyWorkHours || 8.0,
        screenTimeHours: initialData?.screenTimeHours || 3.0,
        moodLevel: initialData?.moodLevel || 3,
        mentalWellbeingNote: initialData?.mentalWellbeingNote || ''
    });
    ...
    return (
        <form onSubmit={handleSubmit} className="assessment-form">
            ...
            <div className="form-group">
                ...
                >
                    {isSubmitting ? 'Saving...' : mode === 'edit' ? 'Update Assessment' : 'Create Assessment'}
                </button>
            </div>
        </form>
    );
